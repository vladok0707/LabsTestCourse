...
namespace Aircompany
{
    public class Runner
    {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("Military airport sorted by max flight distance:\n" + militaryAirport.SortByMaxDistance().ToString());
            Console.WriteLine("Passenger airport sorted by max speed:\n" + passengerAirport.SortByMaxSpeed().ToString());
            Console.WriteLine("Passenger plane with max passenger capacity:\n" + passengerAirport.GetPassengerPlaneWithMaxPassengersCapacity());           
        }
    }
}
